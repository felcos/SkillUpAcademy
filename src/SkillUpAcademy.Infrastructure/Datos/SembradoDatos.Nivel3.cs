...
public static partial class SembradoDatos
{
    private static async Task SembrarLeccionesNivel3Async(AppDbContext contexto)
    {
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, lidN3L2,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, teqN3L1,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, teqN3L2,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, ieN3L1,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, ieN3L2,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, netN3L1,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, netN3L2,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, perN3L1,
        ...
        await SembrarEscenasDesdeLeccionAsync(contexto, perN3L2,
